...
define('Core/HemisphereGeometry', function() {
    return Cesium['HemisphereGeometry'];
});

define('Core/HemisphereOutlineGeometry', function() {
    return Cesium['HemisphereOutlineGeometry'];
});
